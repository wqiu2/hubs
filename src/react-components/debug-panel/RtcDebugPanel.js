    ...
    for (const reducedConsumerId in reducedConsumers) {
      ...
      components.push(
        <CollapsiblePanel
          ...
          border
        >
          <CollapsiblePanel row>{panels}</CollapsiblePanel>
        </CollapsiblePanel>
      );
    }
    return components;
    ...
    return (
      <div>
        <div className={classNames(styles.rtcDebugPanelRoot)}>
          <div className={classNames(styles.rtcStatusContainerLeft)}>
            <CollapsiblePanel title={"Local"} isRoot border grow>
              {deviceData && (
          ...
          <div className={classNames(styles.rtcLogContainer)}>
            <CollapsiblePanel title={"Log"} isRoot border grow>
              <p className={classNames(styles.rtcLogMsgContainer)}>{this.createLogMsgs()}</p>
            </CollapsiblePanel>
          </div>
          <div className={classNames(styles.rtcStatusContainerRight)}>
            <CollapsiblePanel title={"Remote"} isRoot border grow>
